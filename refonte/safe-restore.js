...
(function(){
  ...
  const catalogUrl="/MPBP440-V12-Preview/data/music-catalog-v645.json?v=6.4.5";

  function cleanText(s){return (s||"").trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"");}
  function img(src,alt,cls=""){return `<img class="${cls}" src="${src}?v=6.4.5" alt="${alt}" onerror="this.src='/MPBP440-V12-Preview/assets/brand/mpbp440-corp-official.png'">`}
  ...
  function normalizeNav(){
    const routes=[
      {keys:["morceaux","music hub"],url:"/MPBP440-V12-Preview/music/index.html"},
      {keys:["mpbp tv"],url:"/MPBP440-V12-Preview/mpbp-tv/index.html"},
      {keys:["actualite","actus"],url:"/MPBP440-V12-Preview/notifications/index.html"},
      {keys:["a venir","prochaines sorties"],url:"/MPBP440-V12-Preview/music/index.html#avenir"},
      {keys:["evenement","evenements"],url:"/MPBP440-V12-Preview/live/index.html"}
    ];
    ...
    tvLinks.forEach((a,i)=>{a.href="/MPBP440-V12-Preview/mpbp-tv/index.html"; if(i>0 && a.closest("nav")) (a.closest("li")||a).remove();});
  }
  ...
  function card(track, links, upcoming=false){
    const cover=track.cover||"/MPBP440-V12-Preview/assets/brand/mpbp440-corp-official.png";
    ...
    const btns=upcoming
      ? `<a class="mpbp-v645-btn" href="/MPBP440-V12-Preview/music/index.html#avenir">Suivre</a>`
  ...
  async function buildTop(){
    ...
    root.innerHTML=`
      <section class="mpbp-v645-hero">
        ${img("/MPBP440-V12-Preview/assets/brand/mpbp440-corp-official.png","Logo MPBP440","mpbp-v645-logo")}
        <div>
          ...
          <div class="mpbp-v645-artists">
            <a class="mpbp-v645-artist" href="/MPBP440-V12-Preview/artistes/sparetdee-simon.html">${img("/MPBP440-V12-Preview/assets/artists/sparetdee-simon-profile.jpg","Sparetdee Simon")}<div><h3>Sparetdee Simon</h3><p>Rap conscient • Roots • Vibration</p></div></a>
            <a class="mpbp-v645-artist" href="/MPBP440-V12-Preview/artistes/juste-une-plume.html">${img("/MPBP440-V12-Preview/assets/artists/juste-une-plume-profile.jpg","Juste Une Plume")}<div><h3>Juste Une Plume</h3><p>Écriture • Émotion • Plume symbolique</p></div></a>
          </div>
        </div>
      </section>
  ...
  async function ensureMusicPage(){
    if(!location.pathname.includes("/MPBP440-V12-Preview/music")) return;
