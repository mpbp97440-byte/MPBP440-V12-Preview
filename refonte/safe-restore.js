...
(function(){
  ...
  function img(src,alt,cls=""){return `<img class="${cls}" src="${src}?v=6.4.5" alt="${alt}" onerror="this.src='/MPBP440-V12-Preview/assets/brand/mpbp440-official-logo.jpg'">`}
  ...
  function card(track, links, upcoming=false){
    const cover=track.cover||"/MPBP440-V12-Preview/assets/brand/mpbp440-official-logo.jpg";
  ...
  async function buildTop(){
    ...
    root.innerHTML=`
      <section class="mpbp-v645-hero">
        ${img("/MPBP440-V12-Preview/assets/brand/mpbp440-official-logo.jpg","Logo MPBP440","mpbp-v645-logo")}
        <div>
